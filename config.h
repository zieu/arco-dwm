...
static const char col_gray3[]       = "#828fa8"; /* inactive text color */
static const char col_gray4[]       = "#ffffff"; /* active text color */
static const char col_cyan[]        = "#000000"; /* a top-center task name bar*/  
static const char col_border[]      = "#9db9ec";
